...
import { CreateEmployeeInput, updateEmployeeInput } from "./create-employee.input";
...
export class EmployeeResolver {
    ...
    @Mutation(returns => EmployeeType)
    updateEmployee(
        @Args('employeeDetails') employeeDetails: updateEmployeeInput
    ) {
        return this.employeesService.updateEmployee(employeeDetails)
    }
